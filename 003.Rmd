...
ac.error[1] <- (ci[1,5] - aproximations[2] )/ aproximations[2] * 100
ac.error[2] <- ((ci[2,5]) - aproximations[5] )/ aproximations[5] * 100
ac.error[3] <- ((ci[3,5]) - aproximations[8] )/ aproximations[8] * 100
ac.error[4] <- ((ci[4,5])- aproximations[11] )/ aproximations[11] * 100
ac.error
