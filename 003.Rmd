...
We base our verification in basic statistics from the simulation, the mean, the standard deviation and the histogram. We are going to check the the interarrival times $\tau$ and the service times x are correctly following the specified distribution.

We generate 10.000 clients with the simulation.

The mean and sample variance of interarrival times are the following:

The histogram of the interarrival times is shown below:
...
This is apparently following the assigned distribution, however to be sure we need to apply a Chi-squared test.
